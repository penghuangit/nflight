...
public class ServerController {
    ...
    private final static String BASENAME = "resources.ServerApplication";

    private final static String PROPERTIES_NOT_FOUND = "resources/ServerApplication.properties not found";
