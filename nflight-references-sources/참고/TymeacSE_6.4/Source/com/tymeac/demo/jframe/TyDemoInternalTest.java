...
public class TyDemoInternalTest extends javax.swing.JFrame {
  ...
  private static final long serialVersionUID = 1L;
    ...
    private void initComponents() {
        ...
        setTitle(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Tymeac_Internal_Server_Test"));
        StopServer.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Stop_Server"));
        ...
        StartServer.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Start_Server"));
        ...
        SendSingle.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Send_Single"));
        ...
        OpenMenu.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Open_Menu"));
        ...
        CloseMenu.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Close_Menu"));
        ...
        jLabel1.setText(java.util.ResourceBundle.getBundle("com/tymeac/demo/jframe/TyDemoInternalTestProperties").getString("Result:"));
