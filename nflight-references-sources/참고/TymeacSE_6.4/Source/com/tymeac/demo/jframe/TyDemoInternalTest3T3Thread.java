 ...
 * 
 *   One user switch: full_checking - Set to true it randomly develops a passed input to Tymeac
...
public final class TyDemoInternalTest3T3Thread
		  extends Thread {			
		
	// base storage used by all threads.
	private TyDemoInternalTest3T3Base base = null;
    
	// the parameter for Tymeac    
	private TymeacParm TP = null;

	// RMI methods for Tymeac
	private TymeacInterface TSC = null;
 ...
 * 
 */
public TyDemoInternalTest3T3Thread (TyDemoInternalTest3T3Base from, int number, TymeacInterface ti) {	
