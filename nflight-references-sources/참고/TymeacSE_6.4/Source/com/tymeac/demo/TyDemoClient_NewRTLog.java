 ...
 */ 
public class TyDemoClient_NewRTLog {  
...
public static void main(String[] args) {
  ...
  TyNewRTLogClient client = new TyNewRTLogClient();  
  
  if ((args[0]).compareTo("1") == 0) {
    
      System.out.println("status is " + client.resetLog());
      System.exit(0);       
  }
  ...
  System.out.println("status is " + client.newLog(DBMS, Dir, FileName, Alt));   
