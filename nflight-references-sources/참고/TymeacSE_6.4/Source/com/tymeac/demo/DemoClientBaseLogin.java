 ...
 * 
 */
public class DemoClientBaseLogin {
...
//8.
    try {
      ...
      switch (what){
        ...
        case 1:   backArray = new TySvrCommLogin().syncRequest(TP);
                  return;
        
        case 2:   backArray = new TySvrCommLogin().asyncRequest(TP);
                  return;
        
        case 3:   backString = new TySvrCommLogin().shutRequest(force);
                  return;
