...
public class TyDemoInternalClientCancelled2 {
 ...
 * Constructor 
 */
public TyDemoInternalClientCancelled2() {
 ...
 * 1. start the server
 * 2. start the new thread for a cancel
 * 3. send a sync request for Function_4 with a cancel word in the parm
 * 4  the new thread calls the server with a cancelSyncReq()
 * 5. do an overall request to see what is active in the system  
 * 6. wait 10 seconds
...
// 2    
    // new thread
    new Thread(new InvokeRunnable(cp)).start();  
...
public static void main(String args[]) {
  ...
  new TyDemoInternalClientCancelled2().init();
