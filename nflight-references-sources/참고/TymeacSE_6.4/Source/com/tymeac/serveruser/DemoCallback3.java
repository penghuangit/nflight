 ...
 *   Invoked method for processing Tymeac Callback Demonstration Queue, CALC..  
 *
 *
 */

public class DemoCallback3 {  
    ...
    try {
          ...
          if  (input != null) {
                ...
                if  (len > 17) {
                      ...
                      // all are here
                      A = input.substring(12,14);
                      B = input.substring(14,16);
                      C = input.substring(16,18);
                }   
                else {
