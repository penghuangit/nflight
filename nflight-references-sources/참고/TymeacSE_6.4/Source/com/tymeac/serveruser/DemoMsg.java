...
/**
 * Demonstration of private environment functionality. 
 *
 * 
 */
    ...
    try {   
        ...
        if  (args[0] instanceof String) {
          ...
          if  (mt == null) {
              ...
              // back with error
              return "TyDemoMsgBase not initialized properly";

          } // endif

          // wake up the thread and pass the input message
          mt.wakeUp(msg);
    
          // back with good 
          return "Message passed to common routine";
