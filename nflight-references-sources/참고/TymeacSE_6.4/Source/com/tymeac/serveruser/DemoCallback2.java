 ...
 *   Invoked method for processing Tymeac Callback Demonstration Queue, CALB.  
 *
 *
 */

public class DemoCallback2 {  
    ...
    try {
          ...
          if  (input != null) {
                ...
                if  (len > 12) {
                      ...
                      // all are here
                      A = input.substring(6,8);
                      B = input.substring(8,10);
                      C = input.substring(10,12);
                }   
                else {
