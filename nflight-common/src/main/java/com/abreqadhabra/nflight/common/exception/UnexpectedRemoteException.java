 ...
 */
public class UnexpectedRemoteException extends NFlightRemoteException {
     ...
     * @since STEP1
     */
    private static String ERROR_ID = "NF000000";
     ...
     * @since STEP1
     */
    private static String MESSAGE_ID = "CE000000";
     ...
     * @since STEP1
     */
    private static String MESSAGE = "예기치 않은 오류가 발생했습니다.";
     ...
     * @since STEP1
     */
    public UnexpectedRemoteException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public UnexpectedRemoteException(String message, Throwable cause) {
	super(message, cause);
