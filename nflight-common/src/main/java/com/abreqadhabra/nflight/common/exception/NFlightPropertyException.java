 ...
 */
public class NFlightPropertyException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFlightPropertyException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFlightPropertyException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFlightPropertyException(Throwable cause) {
	super(MESSAGE, cause);
