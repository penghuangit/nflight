 ...
 * @see CommonException
 */
public class NFlightRSystemException extends CommonException {
     ...
     * @since STEP1
     */
    public NFlightRSystemException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFlightRSystemException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFlightRSystemException(Throwable cause) {
	super(MESSAGE, cause);
