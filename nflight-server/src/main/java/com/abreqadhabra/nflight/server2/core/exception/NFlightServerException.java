package com.abreqadhabra.nflight.server2.core.exception;
 ...
 */
public class NFlightServerException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFlightServerException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFlightServerException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFlightServerException(Throwable cause) {
	super(MESSAGE, cause);
