package com.abreqadhabra.nflight.server2.rmi;
...
import com.abreqadhabra.nflight.server2.core.NFlightCommands;
...
import com.abreqadhabra.nflight.server2.ns.rmi.ServerController;

public class RMIServer extends NFlightCommands implements NFlightServer {
	...
	public static void main(String[] args) {
		...
		NFlightServer server = new RMIServer();
		String mode = null;
		try {
	...
	public static void printUsage() {
		...
		System.out
				.println("java -cp <classpath> com.abreqadhabra.nflight.server2.rmi.RMIServer [options] [agents]");
