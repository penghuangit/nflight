 ...
 */
public class NFlightRemoteException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFlightRemoteException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFlightRemoteException(Throwable cause) {
	super(MESSAGE, cause);
