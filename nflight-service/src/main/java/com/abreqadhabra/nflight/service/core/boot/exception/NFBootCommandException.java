 ...
 */
public class NFBootCommandException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFBootCommandException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFBootCommandException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFBootCommandException(Throwable cause) {
	super(MESSAGE, cause);
