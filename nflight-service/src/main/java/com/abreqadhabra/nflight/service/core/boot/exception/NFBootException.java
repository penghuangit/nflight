 ...
 */
public class NFBootException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFBootException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFBootException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFBootException(Throwable cause) {
	super(MESSAGE, cause);
