package com.abreqadhabra.nflight.service.core.boot.exception;
 ...
 */
public class NFlightBootCommandException extends WrapperException {
     ...
     * @since STEP1
     */
    public NFlightBootCommandException(String message) {
	super(message);
     ...
     * @since STEP1
     */
    public NFlightBootCommandException(String message, Throwable cause) {
	super(message, cause);
     ...
     * @since STEP1
     */
    public NFlightBootCommandException(Throwable cause) {
	super(MESSAGE, cause);
