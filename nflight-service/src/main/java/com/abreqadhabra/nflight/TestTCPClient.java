...
public class TestTCPClient {
	...
	public TestTCPClient(String url) throws Exception {
		this(url, 9999);
	}

	public TestTCPClient(String url, int port) throws Exception {
	...
	public static void main(String args[]) {
		TestTCPClient tcpClient = null;
		try {
			switch (args.length) {
			case 1:
				tcpClient = new TestTCPClient(args[0]);
				break;
			case 2:
				tcpClient = new TestTCPClient(args[0],
