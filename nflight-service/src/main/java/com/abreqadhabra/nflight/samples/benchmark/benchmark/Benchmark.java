...
/**
 * General com.abreqadhabra.nflight.samples.benchmark.benchmark execution class. Needs to be initialized with a BenchmarkConfig object.
 * Executes a BenchmarkDef that determines the actual actions to perform before, during, and after
 * the com.abreqadhabra.nflight.samples.benchmark.benchmark. Prints timing information for each single run of the com.abreqadhabra.nflight.samples.benchmark.benchmark, and stores any
