...
/**
 * Default configuration for the com.abreqadhabra.nflight.samples.benchmark.actor com.abreqadhabra.nflight.samples.benchmark.benchmark.
 * 
...
public class ActorBenchmarkConfig {
    ...
    /** Maximum number of messages that may be consumed by an com.abreqadhabra.nflight.samples.benchmark.actor within one execution session. */
    public static int MAX_CONSUME_BURST = 1;

    /** Number of dummy work iterations performed by an com.abreqadhabra.nflight.samples.benchmark.actor during execution. */
