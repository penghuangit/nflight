...
import com.abreqadhabra.nflight.samples.benchmark.actor.Dispatcher;
import com.abreqadhabra.nflight.samples.benchmark.actor.Message;

/**
 * Base dispatcher implementation for the parallel com.abreqadhabra.nflight.samples.benchmark.actor benchmarks. The dispatcher maintains the
 * set of mailboxes of all actors and scheduled new messages. When dispatching a message, the
 * dispatcher checks the mailbox state in order to schedule the com.abreqadhabra.nflight.samples.benchmark.actor for execution only if it isn't
 * already scheduled.
 * 
