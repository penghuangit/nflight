 ...
 * contains helper logic for the com.abreqadhabra.nflight.samples.benchmark.benchmark, by providing a way to schedule initial messages and to
 * check if the com.abreqadhabra.nflight.samples.benchmark.benchmark has finished.
 * 
