...
package com.abreqadhabra.nflight.samples.concurrent.benchmark.run;

import com.abreqadhabra.nflight.samples.concurrent.benchmark.actor.ActorBenchmarkMain;
import com.abreqadhabra.nflight.samples.concurrent.benchmark.document.DocumentBenchmarkMain;
...
//	}
	...
	String type = "actor";//args[0];
	String configFile = "actor.properties";//args.length > 1 ? args[1] : null;
	switch (type) {
	case "document":
