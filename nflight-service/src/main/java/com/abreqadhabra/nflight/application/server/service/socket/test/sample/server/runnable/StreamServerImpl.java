package com.abreqadhabra.nflight.application.server.service.socket.test.sample.server.runnable;
...
import com.abreqadhabra.nflight.application.server.service.socket.test.sample.server.EchoWorker;
import com.abreqadhabra.nflight.application.server.service.socket.test.sample.server.SocketServer;

public class StreamServerImpl implements SocketServer, Runnable {
	...
	public StreamServerImpl(InetAddress hostAddress, int port, EchoWorker worker)
			throws IOException {
	...
	public void init() throws IOException {
		...
		if ((selector.isOpen()) && (this.serverChannel.isOpen())) {
			...
			this.serverChannel.register(selector,
