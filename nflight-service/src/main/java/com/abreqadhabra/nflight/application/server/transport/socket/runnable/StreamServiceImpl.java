...
public class StreamServiceImpl {
	...
	private void acceptOperation(SelectionKey key, Selector selector)
			throws IOException {
...
//			serverSocketChannel.bind(new InetSocketAddress(port));
	...
	private void readOperation(SelectionKey key) {
		try {
			SocketChannel socketChannel = (SocketChannel) key.channel();
	...
	private void writeOperation(SelectionKey key) throws IOException {
