package com.abreqadhabra.nflight.application.server.examples.server.datagram;
...
import com.abreqadhabra.nflight.application.common.service.DatagramChannelDescriptor;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (DatagramChannel datagramChannel = DatagramChannel.open(StandardProtocolFamily.INET)) {
          	 ...
          	 NetworkChannelDescriptor desc = new DatagramChannelDescriptor((long) 0, datagramChannel);
