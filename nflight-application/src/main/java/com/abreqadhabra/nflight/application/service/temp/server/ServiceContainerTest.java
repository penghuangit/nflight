...
import com.abreqadhabra.nflight.application.launcher.LauncherHelper;
import com.abreqadhabra.nflight.common.logging.LoggingHelper;

public class ServiceContainerTest implements INetworkService {
	private static Class<ServiceContainerTest> THIS_CLAZZ = ServiceContainerTest.class;
	...
	public ServiceContainerTest(Configure configure) throws NFlightException,
	...
	public static void main(String[] args) {
		try {
			...
			ServiceContainerTest container = new ServiceContainerTest(configure);
			container.startup();
		} catch (Exception e) {
