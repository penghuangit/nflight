package com.abreqadhabra.nflight.application.service.temp.client;
...
public class ServiceClientTest {
	...
	public static ClientChannelFactory createSocketChannelFactory() {
				...
				LOGGER.logp(
						...
						"current thread is "
								+ ThreadHelper.getThreadName(Thread
										.currentThread()));
				try {
					Servant stub = (Servant) this.registry
