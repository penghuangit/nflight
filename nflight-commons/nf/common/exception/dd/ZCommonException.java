 ...
 * </p>
 * <p>
 * [비 고] RunTimeException을 상속받고 있기 때문에 반드시 try ~ catch를 추가할 필요는 없습니다. <br>
...
public class ZCommonException extends ContextedException implements ICommonException{
	 ...
	 * @since STEP1
	 */
	public ZCommonException(String message) {
	 ...
	 * @since STEP1
	 */
	public ZCommonException(String message, Throwable childException) {
	 ...
	 * @since STEP1
	 */
	public ZCommonException(Throwable childException) {
		// 부모 클래스의 동일 인수를 가진 생성자를 호출합니다.
	     ...
	     */
	    public ZCommonException addContextValue(String label, Object value) {        
	     ...
	     * @return {@code this}, for method chaining, not {@code null}
	     */
	    public ZCommonException setContextValue(String label, Object value) {        
