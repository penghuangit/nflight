 ...
 * @since STEP1
 */
public class NestedRuntimeException_ extends RuntimeException {
     ...
     * @since STEP1
     */
    public NestedRuntimeException_(String strArg) {
     ...
     * @since STEP1
     */
    public NestedRuntimeException_(String strArg, Throwable childExceptionArg) {
